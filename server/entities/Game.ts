import {Entity, BaseEntity, PrimaryGeneratedColumn, Column, ManyToMany, OneToMany, JoinTable} from "typeorm";
...
export default class Game extends BaseEntity {
    ...
    @OneToMany(() => GameTags, gameTags => gameTags.game)
    game_tags: GameTags[]
